...
#
#     result = following_response_from_dict(json.loads(json_string))
...
class FollowingResponse:
    ...
    def from_dict(obj: Any) -> 'FollowingResponse':
        ...
        return FollowingResponse(next_max_id, users, big_list, page_size, should_limit_list_of_followers, status)
